        ...
        <div className="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
          ...
          >
            ...
            <li className="nav-item">
              ...
              >
                ...
                <span className="ms-1 d-none d-sm-inline ">Sobre Mi</span>
              </NavLink>
            </li>
            <li className="nav-item">
              <NavLink
            ...
            <li className="nav-item">
              ...
              >
                ...
                <span className="ms-1 d-none d-sm-inline ">Experencia</span>
              </NavLink>
            </li>
            <li className="nav-item">
              <NavLink
          ...
          <div className="dropdown pb-4 dropup">
            ...
            >
              ...
              <span className="d-none d-sm-inline mx-1">Contacto</span>
            </a>
            <ul
            ...
            >
              <li>
                <a
                  ...
                  href="mailto:egvargas89@hotmail.com"
                  target="/blank"
                >
                  <MdEmail className="fs-5" /> Correo
                </a>
              </li>
              <li>
                {" "}
              ...
              <li>
                <a
                  className="dropdown-item text-black"
                  href="https://github.com/egvargas"
                  target="/blank"
                >
